-- Script para corrigir a função upsert_organization_jsonb
-- Execute este script no Supabase SQL Editor
-- Este script recria a função completa e corrigida

-- Drop a função existente se houver
DROP FUNCTION IF EXISTS upsert_organization_jsonb(uuid, jsonb);

-- Recriar a função sem validação de auth.uid()
