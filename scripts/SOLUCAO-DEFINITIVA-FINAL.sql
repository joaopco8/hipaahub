-- ============================================================================
-- SOLUÇÃO DEFINITIVA - Execute este script COMPLETO no Supabase SQL Editor
-- ============================================================================
-- Este script resolve o erro "operator does not exist: text = uuid" de UMA VEZ POR TODAS
-- ============================================================================
...
-- ============================================================================
-- PASSO 2: CRIAR FUNÇÃO CORRETA (SEM TEXT, SEM UUID NA ASSINATURA)
-- ============================================================================
...
BEGIN
  ...
  IF v_existing_org_id IS NULL THEN
    ...
    VALUES (
      ...
      COALESCE(NULLIF(p_data->>'state', ''), NULLIF(p_data->>'address_state', ''), 'CA'),
  ...
  ELSE
    ...
    SET
      ...
      state = COALESCE(NULLIF(p_data->>'state', ''), NULLIF(p_data->>'address_state', ''), o.state),
...
-- ============================================================================
-- PASSO 4: FORÇAR REFRESH DO CACHE (MÚLTIPLAS VEZES)
-- ============================================================================
...
-- FIM
-- ============================================================================
SELECT '✅ SCRIPT CONCLUÍDO - Aguarde 30 segundos e teste novamente' as mensagem_final;
