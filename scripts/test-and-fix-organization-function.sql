-- Script completo para testar e corrigir a função upsert_organization_jsonb
...
BEGIN
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'Constraint organizations_user_id_key criada';
  ELSE
...
-- Passo 3: Drop e recriar a função
...
-- Passo 5: Verificar se há triggers que podem estar interferindo
SELECT 
  trigger_name,
  event_manipulation,
  action_statement
