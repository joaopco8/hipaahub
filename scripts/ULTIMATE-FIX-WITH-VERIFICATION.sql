-- ============================================================================
-- CORREÇÃO ULTIMATE COM VERIFICAÇÃO COMPLETA
-- ============================================================================
-- Execute este script COMPLETO no Supabase SQL Editor
-- ============================================================================

-- ============================================================================
-- PASSO 0: VERIFICAR TIPO DA COLUNA user_id (CRÍTICO!)
-- ============================================================================
SELECT 
  'VERIFICAÇÃO TIPO COLUNA' as etapa,
  column_name, 
  data_type,
...
-- ============================================================================
-- PASSO 1: LISTAR TODAS AS FUNÇÕES ANTES DA LIMPEZA
-- ============================================================================
SELECT 
...
BEGIN
  ...
  LOOP
    ...
    EXCEPTION WHEN OTHERS THEN
      RAISE NOTICE '⚠️ Erro: %(%) - %', r.proname, r.args, SQLERRM;
    END;
  END LOOP;
...
-- ============================================================================
-- PASSO 4: CRIAR FUNÇÃO DEFINITIVA
-- ============================================================================
...
AS $$
DECLARE
  v_user_id uuid;  -- CRÍTICO: Declarar como UUID
  v_org_id uuid;
...
BEGIN
  ...
  -- ========================================================================
  -- VERIFICAR EXISTÊNCIA - v_user_id é UUID, o.user_id é UUID
  -- ========================================================================
  ...
  ELSE
    -- UPDATE - v_user_id é UUID, o.user_id é UUID
