...
-- ============================================================================
-- 1. Abra: https://app.supabase.com > Seu Projeto > SQL Editor > New Query
-- 2. Copie TODO este conteúdo (Ctrl+A, Ctrl+C)
...
BEGIN
  ...
  SELECT id INTO v_existing_id FROM organizations WHERE user_id = v_user_id LIMIT 1;
