-- ============================================================================
-- Fix upsert_organization_jsonb to support ALL organization fields
-- ============================================================================
-- This migration updates the RPC function to handle all HIPAA required fields
-- including US legal identifiers, conditional fields, and optional fields
-- ============================================================================
...
'Comprehensive upsert for organization data including all HIPAA required fields.
Uses authenticated user ID from auth.uid() internally (SECURITY DEFINER).
Supports US legal identifiers, conditional fields, and optional fields.';
