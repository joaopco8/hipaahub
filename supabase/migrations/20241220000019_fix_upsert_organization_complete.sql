-- Migration completa e corrigida para upsert_organization_jsonb
-- Esta versão resolve todos os problemas:
-- 1. Ambiguidade de user_id
-- 2. Geração de id
-- 3. Campos created_at e updated_at obrigatórios
