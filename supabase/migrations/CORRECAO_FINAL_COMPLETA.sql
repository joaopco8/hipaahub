-- ============================================================================
-- CORREÇÃO DEFINITIVA COMPLETA - Verifica e corrige TUDO
-- ============================================================================
-- Execute este script no Supabase SQL Editor
-- ============================================================================

-- PASSO 1: Verificar tipo da coluna user_id
DO $$
DECLARE
    v_user_id_type text;
BEGIN
...
-- Remover qualquer função com nome similar usando loop
DO $$
DECLARE
    r record;
BEGIN
...
-- PASSO 3: Garantir que a coluna de metadata existe
ALTER TABLE organizations 
...
-- PASSO 4: Criar função CORRETA com tipos explícitos
