...
OCR expects you to be able to show your work. If you canâ€™t produce a structured risk analysis and a remediation trail, youâ€™re exposed.
...
- **Risk rating**: impact Ã— likelihood (be consistent).
...
- Likelihood: 1 (rare) â†’ 5 (frequent)
...
If your policy says â€œwe enforce MFA,â€ your evidence must show MFA is enforced.

## How often should you redo the SRA?

At least annuallyâ€”and also after major changes such as:
