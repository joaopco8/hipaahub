...
const ReportCard: React.FC<{
  ...
  <div className="bg-white border border-gray-100 group overflow-hidden flex flex-col h-full hover:shadow-2xl transition-all duration-500">
    ...
    <div className="p-8 flex-grow flex flex-col">
      ...
      <h4 className="text-xl font-thin text-cisco-navy mb-4 leading-tight group-hover:text-cisco-blue transition-colors">{title}</h4>
      <p className="text-gray-500 text-sm font-thin leading-relaxed mb-8">{desc}</p>
    ...
    <div className="bg-white min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-12 shadow-2xl overflow-hidden group">
                 ...
                 <h3 className="text-3xl font-thin mb-6">2026 Healthcare Threat Landscape</h3>
                 <p className="text-gray-400 font-thin text-base leading-relaxed mb-12">
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          <div className="flex justify-between items-end mb-16 border-b pb-12 border-gray-200">
            <div>
              <h2 className="text-3xl font-thin text-cisco-navy">Intelligence Publication Library</h2>
              <p className="text-gray-500 font-thin mt-2">Specialized research curated for medical boards and clinical directors.</p>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
           ...
           <h2 className="text-3xl md:text-5xl font-thin text-cisco-navy mb-8">Actionable Briefings.</h2>
