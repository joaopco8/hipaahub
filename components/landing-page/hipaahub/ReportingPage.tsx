      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-12 grid lg:grid-cols-2 gap-24 items-center">
          <div>
            ...
            <p className="text-gray-600 text-lg font-thin leading-relaxed mb-12">
            ...
            <div className="space-y-8 mb-12">
               <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 font-thin">Generate the specific reporting structure used by OCR in federal desk audits.</p>
                  </div>
               </div>
               <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 font-thin">Timestamped logs and digital signatures for all compliance artifacts.</p>
                  </div>
               </div>
            </div>
