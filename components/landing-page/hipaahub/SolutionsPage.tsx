          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-white/50 p-6 border border-gray-100 shadow-sm">
              <div className="mb-6">
                ...
                <p className="text-xl font-thin text-cisco-navy">{investment}</p>
              </div>
              {timeline && (
                <div>
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-[650px] w-full bg-cisco-navy overflow-hidden flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-12 text-white">
          <div className="max-w-4xl">
            <p className="text-xs font-thin text-blue-400 mb-6">Consulting Portfolio</p>
            ...
            <h3 className="text-xl md:text-2xl font-thin text-gray-300 mb-10 border-l-2 border-cisco-blue pl-8">
            ...
            <p className="text-gray-400 text-lg font-thin leading-relaxed mb-12 max-w-2xl">
            ...
            <button className="bg-cisco-blue text-white px-12 py-5 text-sm font-thin hover:bg-white hover:text-cisco-navy transition-all">
      ...
      <section className="bg-cisco-navy py-24 md:py-32 overflow-hidden text-center text-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h2 className="text-4xl md:text-6xl font-thin mb-10">Determine Your <br /> Compliance Status.</h2>
      ...
      <section className="bg-white py-24 border-t">
        <div className="max-w-7xl mx-auto px-4 md:px-12 grid md:grid-cols-3 gap-16">
          ...
          <div className="space-y-4">
            ...
            <h4 className="text-xl font-thin text-cisco-navy">Clinical Continuity</h4>
            <p className="text-gray-500 text-sm font-thin leading-relaxed">
          ...
          <div className="space-y-4">
            ...
            <h4 className="text-xl font-thin text-cisco-navy">Expert Advisory</h4>
            <p className="text-gray-500 text-sm font-thin leading-relaxed">
