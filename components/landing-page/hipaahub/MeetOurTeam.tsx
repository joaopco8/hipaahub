  ...
  <div className="group bg-white border border-gray-100 p-0 hover:border-cisco-navy transition-all duration-300 hover:shadow-xl">
    <div className="h-80 overflow-hidden relative bg-gray-100">
      <img 
        ...
        loading="lazy"
      />
      <div className="absolute bottom-0 left-0 bg-cisco-navy text-white px-4 py-1.5 text-xs font-thin z-10">
        Expert
      </div>
    </div>
    <div className="p-8">
      <h4 className="text-xl font-thin text-cisco-navy mb-1">{name}</h4>
      <p className="text-gray-500 text-sm font-thin mb-6">{role}</p>
      <ul className="space-y-3 mb-8">
        {bullets.map((bullet, idx) => (
          <li key={idx} className="flex items-start text-xs text-gray-600 font-thin leading-relaxed">
...
const MeetOurTeam: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-gray-50 border-t border-b border-gray-200 border-[0.5px]">
      <div className="max-w-7xl mx-auto px-4 md:px-12">
        <div className="mb-16">
          <p className="text-cisco-navy font-thin text-xs mb-4">Our Expertise</p>
          <h2 className="text-4xl lg:text-[48px] font-thin text-cisco-navy leading-tight mb-6">
            Expert-Led Consulting. <br /> Regulatory Expertise.
          </h2>
          <p className="text-gray-600 text-lg font-thin max-w-2xl leading-relaxed">
        ...
        <div className="mt-20 p-10 bg-white border border-gray-100 flex flex-col md:flex-row items-center justify-between gap-8">
           <div className="max-w-xl">
              <h3 className="text-2xl font-thin text-cisco-navy mb-2">Specialized Services Available</h3>
              <p className="text-gray-600 font-thin">For complex multi-site audits and unique clinical workflows, our experts are available for specialized consultation.</p>
           </div>
           <button className="bg-cisco-navy text-white px-10 py-4 font-thin text-sm hover:bg-cisco-blue transition-all rounded-none whitespace-nowrap">
