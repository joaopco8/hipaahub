...
const SocialProof: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-gray-50 border-t border-b border-gray-200 border-[0.5px] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-12">
        <div className="bg-white shadow-sm border border-gray-100 flex flex-col lg:flex-row min-h-[450px]">
          ...
          <div className="flex-grow p-10 md:p-16 lg:w-3/4 flex flex-col justify-center">
            <div className="animate-reveal key={current.id}">
              <h3 className="text-2xl md:text-[28px] font-thin italic text-slate-700 mb-8 leading-tight">
                “{current.subhead}”
              </h3>
              <p className="text-gray-600 leading-relaxed mb-12 max-w-3xl text-base font-thin">
                “{current.quote}”
              </p>
              
              <div className="mb-10">
                <p className="font-thin text-slate-900 text-sm">
                  {current.author}, <span className="font-thin text-slate-700">{current.role}</span>
                </p>
                <p className="text-gray-400 text-xs mt-1 font-thin">
                  {current.credentials}
                </p>
              </div>
              
              <div className="flex flex-wrap items-center gap-x-12 gap-y-4 text-sm font-thin">
          ...
          <div className="lg:w-1/4 relative min-h-[300px] lg:min-h-full overflow-hidden border-l border-gray-50">
            ...
            />
            {/* Branding Overlay */}
            <div className="absolute bottom-6 right-6 text-white font-thin opacity-70 text-[10px]">
              Hipaa Hub
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 flex flex-wrap gap-12 justify-center">
          <div className="text-center">
            <p className="text-[10px] font-thin text-cisco-blue">Result</p>
            <p className="text-sm font-thin text-cisco-navy mt-1">Audit readiness achieved</p>
          </div>
          <div className="text-center">
            <p className="text-[10px] font-thin text-cisco-blue">Timeline</p>
            <p className="text-sm font-thin text-cisco-navy mt-1">7 business days</p>
          </div>
          <div className="text-center">
             <p className="text-[10px] font-thin text-cisco-blue">Verified customer</p>
             <p className="text-sm font-thin text-cisco-navy mt-1">Authenticated user</p>
          </div>
        </div>
      </div>
    </section>
