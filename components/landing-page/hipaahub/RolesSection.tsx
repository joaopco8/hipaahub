...
const RoleCard: React.FC<{ title: string; desc: string }> = ({ title, desc }) => (
  <div className="bg-white p-8 border border-gray-200 flex flex-col h-full">
    ...
    <p className="text-gray-600 text-sm mb-12 flex-grow leading-relaxed font-thin">{desc}</p>
    <div className="space-y-1">
        <a href="#" className="flex items-center text-blue-500 text-sm font-thin group">
  ...
  return (
    <section className="py-24 bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 grid md:grid-cols-2 gap-16 items-center mb-24">
        ...
        <div>
          <h2 className="text-4xl font-thin text-slate-800 leading-tight mb-8">
            Be ready for roles that <br /> support collaboration
          </h2>
          <p className="text-gray-600 text-lg mb-10 leading-relaxed max-w-lg font-thin">
            Collaboration professionals use their expertise to build and maintain the robust 
            networks that connect us all.
          </p>
          <button className="border border-blue-500 text-blue-500 px-8 py-3 text-sm font-thin hover:bg-blue-50 transition-colors">
            Secondary CTA
          </button>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12">
        <h3 className="text-2xl font-thin text-slate-800 mb-12">Potential roles</h3>
