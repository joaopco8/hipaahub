    ...
    <section className="py-24 bg-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-12">
        <div className="text-center mb-20">
          <h2 className="text-4xl lg:text-[54px] font-thin text-cisco-navy leading-tight mb-6">Enterprise-Grade <br /> Compliance & Security.</h2>
          <h3 className="text-xl font-thin text-cisco-blue">Built for healthcare compliance and data protection.</h3>
        </div>

        <div className="grid lg:grid-cols-3 gap-12">
          {/* Certs */}
          <div className="bg-white p-10 border border-gray-100 shadow-sm">
            <h4 className="text-[10px] font-thin text-cisco-blue mb-8 border-b pb-4">Compliance certifications</h4>
            <ul className="space-y-4">
              {["HIPAA Compliant", "SOC 2 Type II Certified", "NIST 800-53 Aligned", "HITRUST CSF Certified"].map((c, i) => (
                <li key={i} className="flex items-center text-sm text-gray-600 font-thin">
          ...
          {/* Features */}
          <div className="bg-white p-10 border border-gray-100 shadow-sm">
            <h4 className="text-[10px] font-bold text-cisco-blue mb-8 border-b pb-4">Security features</h4>
            <ul className="space-y-4">
          ...
          {/* Protection */}
          <div className="bg-white p-10 border border-gray-100 shadow-sm">
            <h4 className="text-[10px] font-bold text-cisco-blue mb-8 border-b pb-4">Data protection</h4>
            <ul className="space-y-4">
        ...
        <div className="mt-16 text-center">
           <button className="bg-cisco-navy text-white px-10 py-5 text-xs font-thin hover:bg-cisco-blue transition-all">
