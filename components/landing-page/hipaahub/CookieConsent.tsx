    ...
    <div className="fixed bottom-6 right-6 z-[100] max-w-sm w-full transition-all duration-500 transform translate-y-0 opacity-100">
      <div className="bg-white border border-gray-200 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] p-8 relative">
        ...
        <div className="flex items-center space-x-2 mb-4">
          ...
          <span className="text-xs font-thin text-cisco-navy">Privacy & Cookies</span>
        </div>

        <h4 className="text-xl font-thin text-cisco-navy mb-3">Your privacy is important</h4>
        
        <p className="text-gray-500 text-base leading-relaxed mb-8 font-thin">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button 
            ...
            className="flex-1 bg-cisco-blue text-white py-4 text-sm font-thin hover:bg-cisco-navy transition-all rounded-none"
          >
            Accept
          </button>
          <button 
            onClick={handleDecline}
            className="flex-1 border border-gray-200 text-cisco-navy py-4 text-sm font-thin hover:bg-gray-50 transition-all rounded-none"
          >
            Decline
          </button>
        </div>
