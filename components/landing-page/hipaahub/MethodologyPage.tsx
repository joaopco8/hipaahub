      ...
      <div className={`grid lg:grid-cols-2 gap-20 items-start ${reverse ? 'lg:flex-row-reverse' : ''}`}>
        <div className="animate-reveal">
          <div className="flex items-center gap-6 mb-10">
            <div className="w-14 h-14 bg-cisco-navy text-white flex items-center justify-center font-thin text-2xl shadow-xl">
              {number}
            </div>
          ...
          <h2 className="text-3xl md:text-5xl font-thin text-cisco-navy mb-6 leading-tight">
            {title}
          </h2>
          <h3 className="text-xl font-thin text-cisco-blue mb-8">
            {subtitle}
          </h3>
          <p className="text-gray-600 text-lg font-thin leading-relaxed mb-10 border-l-2 border-gray-100 pl-8">
            {body}
          </p>
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-[650px] w-full bg-cisco-navy overflow-hidden flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-12 text-white">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-thin leading-tight mb-10">
              The Framework for <br /> Audit Defense.
            </h1>
            <p className="text-gray-300 text-lg md:text-2xl font-thin leading-relaxed max-w-2xl border-l-2 border-cisco-blue pl-8 mb-12">
      ...
      <section id="timeline" className="py-32 bg-gray-50 border-b overflow-hidden scroll-mt-32">
        <div className="max-w-7xl mx-auto px-4 md:px-12 text-center">
          <div className="mb-24">
            <h2 className="text-3xl md:text-5xl font-thin text-cisco-navy mb-6 uppercase tracking-tight">Implementation Pipeline.</h2>
      ...
      <section className="bg-cisco-navy py-24 md:py-32 text-center text-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h2 className="text-4xl md:text-6xl font-thin mb-10 leading-tight">Map Your Path to <br /> Compliance.</h2>
