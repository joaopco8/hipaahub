...
const LeadershipMember: React.FC<{
  ...
  <div className="flex flex-col group">
    ...
    <h4 className="text-xl font-thin text-cisco-navy group-hover:text-cisco-blue transition-colors">{name}</h4>
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-cisco-navy text-white py-24 md:py-32 overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-12 relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-thin leading-tight mb-8">
              Infrastructure for <br /> Regulatory Continuity.
            </h1>
            <p className="text-gray-300 text-lg md:text-2xl font-thin leading-relaxed max-w-2xl border-l-2 border-cisco-blue pl-8">
      ...
      <section id="mission" className="py-24 bg-white border-b scroll-mt-32">
        <div className="max-w-7xl mx-auto px-4 md:px-12 grid lg:grid-cols-2 gap-24 items-center">
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-thin text-cisco-navy mb-8 leading-tight">Institutional Mission.</h2>
            ...
            <div className="grid sm:grid-cols-1 gap-y-6">
              {[
                ...
                <div key={i} className="flex items-center text-sm font-bold text-cisco-navy">
                  ...
                  <span>{item.t} — <span className="text-gray-400 font-thin">{item.s}</span></span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section id="philosophy" className="py-24 bg-gray-50 border-b scroll-mt-32">
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          <div className="mb-20 text-center">
            <h2 className="text-3xl md:text-5xl font-thin text-cisco-navy mb-6">Foundational Philosophy.</h2>
            <p className="text-gray-500 font-thin max-w-2xl mx-auto text-lg leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          <div className="grid lg:grid-cols-3 gap-24 items-start">
            <div className="lg:col-span-1">
              ...
              <h2 className="text-3xl font-thin text-cisco-navy mb-8 leading-tight">Leadership & <br /> Expertise.</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-thin text-cisco-navy mb-8 leading-tight">Track Record of <br /> Operational Success.</h2>
              <p className="text-gray-600 text-lg font-thin leading-relaxed mb-10">
              ...
              <div className="grid grid-cols-2 gap-8 mb-12">
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-4xl font-thin text-cisco-navy">100%</p>
                  </div>
                  <div>
                    <h4 className="text-[10px] font-bold text-gray-400 mb-1 uppercase tracking-widest">Implementation Speed</h4>
                    <p className="text-xl font-thin text-cisco-navy">7–21 Days</p>
                  </div>
                </div>
                <div className="bg-white p-8 border border-gray-100 shadow-sm">
                   <h4 className="text-[10px] font-bold text-gray-400 mb-4 uppercase tracking-widest">Global Clinical Footprint</h4>
                   <p className="text-2xl font-thin text-cisco-blue mb-2">500+</p>
                   <p className="text-xs text-gray-500 font-thin leading-relaxed">Secure clinics across 42 states and 14 clinical specialties.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative group">
              <div className="bg-cisco-navy p-12 md:p-20 text-white relative z-10 overflow-hidden shadow-2xl">
                 ...
                 <h3 className="text-3xl font-thin mb-8 leading-tight">Institutional <br /> Scalability.</h3>
                 <p className="text-gray-400 font-thin mb-12 leading-relaxed text-lg">
      ...
      <section id="contact" className="py-32 bg-white overflow-hidden scroll-mt-32">
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          <div className="grid lg:grid-cols-3 gap-24 items-start">
            <div className="lg:col-span-1">
              <h2 className="text-3xl md:text-5xl font-thin text-cisco-navy mb-8 leading-tight">Contact & <br /> Inquiries.</h2>
              <p className="text-gray-500 font-thin leading-relaxed mb-12">
              ...
              <div className="space-y-10">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-cisco-navy text-sm font-thin leading-relaxed">Regulatory District, Ste 402<br />San Jose, CA 95113</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-gray-50 p-12 md:p-16 border border-gray-100 shadow-sm">
                <h3 className="text-2xl font-thin text-cisco-navy mb-10 tracking-tight">Institutional Inquiry Form</h3>
