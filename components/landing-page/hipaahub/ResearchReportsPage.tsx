        ...
        <div className={reverse ? 'lg:order-2' : 'lg:order-1'}>
          ...
          <div className="flex flex-wrap gap-8 mb-12 py-6 border-y border-gray-100">
            <div>
              ...
              <p className="text-sm font-thin text-cisco-navy">{format}</p>
            </div>
            {audience && (
              <div>
                <h4 className="text-[10px] font-bold text-gray-400 mb-1">Target Audience</h4>
                <p className="text-sm font-thin text-cisco-navy">{audience}</p>
              </div>
            )}
          </div>
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-white pt-24 pb-16 md:pt-32 md:pb-24 border-b">
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          <div className="max-w-4xl">
            <p className="text-xs font-thin text-blue-400 mb-6">Intelligence Division</p>
            ...
            <p className="text-gray-500 text-lg md:text-xl font-thin leading-relaxed max-w-2xl">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          <div className="grid lg:grid-cols-3 gap-24 items-start">
            <div className="lg:col-span-1">
              ...
              <h2 className="text-3xl font-thin text-cisco-navy mb-6">Technical Briefings.</h2>
              <h3 className="text-lg font-thin text-cisco-blue mb-8">
                In-depth analysis of specific compliance topics.
              </h3>
              <p className="text-gray-500 font-thin leading-relaxed mb-10">
            ...
            <div className="lg:col-span-2 grid md:grid-cols-2 gap-8">
              {[
                ...
                <div key={i} className="bg-gray-50 p-8 border border-gray-100 hover:border-cisco-blue transition-colors group cursor-pointer">
                  ...
                  <h4 className="text-xl font-thin text-cisco-navy mb-8 leading-tight group-hover:text-cisco-blue transition-colors">
                    {brief.title}
                  </h4>
                  <div className="flex items-center justify-between text-[11px] font-thin mt-auto">
      ...
      <section id="articles" className="py-24 bg-gray-50 scroll-mt-32">
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-5xl font-thin text-cisco-navy mb-6">Articles & Regulatory Analysis.</h2>
            <h3 className="text-lg md:text-xl font-thin text-cisco-blue mb-8">
              Regular analysis of compliance developments, regulatory changes, and industry trends.
            </h3>
            <p className="text-gray-500 font-thin max-w-2xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="bg-white p-6 border border-gray-100 flex items-center justify-between group hover:bg-white hover:shadow-lg transition-all cursor-pointer">
                  <h5 className="text-lg font-thin text-cisco-navy group-hover:text-cisco-blue transition-colors">{article}</h5>
                  <ChevronRight size={18} className="text-gray-300 group-hover:text-cisco-blue group-hover:translate-x-1 transition-all" />
                </div>
              ))}
            </div>
            <div className="text-center mt-12">
              <button className="bg-cisco-navy text-white px-10 py-4 text-xs font-thin hover:bg-cisco-blue transition-all">
                View All Articles
              </button>
            </div>
          </div>
      ...
      <section className="bg-cisco-navy py-24 md:py-32 overflow-hidden text-center text-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h2 className="text-4xl md:text-6xl font-thin mb-10 leading-tight">Stay Informed on <br /> Regulatory Developments.</h2>
      ...
      <section className="bg-white py-24 border-t">
        <div className="max-w-7xl mx-auto px-4 md:px-12 grid md:grid-cols-3 gap-16">
          <div className="space-y-4">
            ...
            <h4 className="text-xl font-thin text-cisco-navy">Institutional Access</h4>
          ...
          <div className="space-y-4">
            ...
            <h4 className="text-xl font-thin text-cisco-navy">Data Integrity</h4>
            <p className="text-gray-500 text-sm font-thin leading-relaxed">
          ...
          <div className="space-y-4">
            ...
            <h4 className="text-xl font-thin text-cisco-navy">Rapid Briefings</h4>
            <p className="text-gray-500 text-sm font-thin leading-relaxed">
