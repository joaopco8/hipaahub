...
const VideoTutorial: React.FC = () => {
  return (
    <section className="py-24 bg-gray-50 border-b border-gray-200 border-[0.5px] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-12">
        <div className="grid lg:grid-cols-5 gap-16 items-center">
          <div className="lg:col-span-2">
            <h2 className="text-4xl lg:text-[48px] font-thin text-cisco-navy leading-tight mb-8">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-center text-sm text-gray-600 font-thin">
