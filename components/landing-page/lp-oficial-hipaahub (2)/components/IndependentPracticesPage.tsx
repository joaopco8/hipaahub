...
const PracticeType: React.FC<{
  ...
  <div className="bg-white border border-gray-100 p-10 flex flex-col h-full hover:shadow-2xl transition-all duration-500 group">
    ...
    <h3 className="text-2xl font-light text-cisco-navy mb-8">{title}</h3>
    ...
    <div className="mb-8 flex-grow">
      ...
      <p className="text-sm text-gray-600 font-light leading-relaxed">{solution}</p>
    </div>
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="py-24 bg-white border-t">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-light text-cisco-navy mb-8">Operational Defensibility.</h2>
