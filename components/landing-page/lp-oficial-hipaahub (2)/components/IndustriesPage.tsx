          ...
          <div className="bg-white/50 p-8 border border-gray-100 shadow-sm mb-10">
            ...
            <div className="grid grid-cols-2 gap-8 pt-6 border-t border-gray-50">
               <div>
                  ...
                  <p className="text-base font-normal text-cisco-navy">{investment}</p>
               </div>
               <div>
                  <h4 className="text-[10px] font-bold text-gray-400 mb-1">Timeline</h4>
                  <p className="text-base font-normal text-cisco-navy">{timeline}</p>
               </div>
            </div>
          </div>
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-white pt-24 pb-16 md:pt-32 md:pb-24 border-b">
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          <div className="max-w-4xl">
            <p className="text-xs font-normal text-blue-400 mb-6">Sector Specialization</p>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-light text-cisco-navy leading-tight mb-10">
            ...
            <button className="bg-cisco-navy text-white px-12 py-5 text-sm font-normal hover:bg-cisco-blue transition-all">
      ...
      <section className="bg-cisco-navy py-24 md:py-32 overflow-hidden text-center text-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h2 className="text-4xl md:text-6xl font-light mb-10">Find Your <br /> Industry Solution.</h2>
          ...
          <button className="bg-cisco-blue text-white px-12 py-5 text-sm font-normal hover:bg-white hover:text-cisco-navy transition-all group flex items-center mx-auto">
      ...
      <section className="bg-white py-24 border-t">
        <div className="max-w-7xl mx-auto px-4 md:px-12 grid md:grid-cols-3 gap-16">
          <div className="space-y-4">
            ...
            <h4 className="text-xl font-light text-cisco-navy">Institutional Depth</h4>
          ...
          <div className="space-y-4">
            ...
            <h4 className="text-xl font-light text-cisco-navy">Rapid Verticalization</h4>
            <p className="text-gray-500 text-sm font-light leading-relaxed">
