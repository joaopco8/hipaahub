    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-white py-24 border-b">
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          <div className="max-w-4xl">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-light text-cisco-navy leading-[1.2] mb-8">
            ...
            <p className="text-gray-600 text-lg md:text-xl font-light leading-relaxed max-w-2xl mb-12">
          ...
          <div className="mt-8 bg-white border border-gray-200 p-8 flex flex-col md:flex-row items-center justify-between gap-8">
             <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs font-light mt-1">Quarterly reviews, annual assessments, and regulatory update alerts.</p>
                </div>
             </div>
      ...
      <section className="bg-cisco-navy py-24 md:py-32 overflow-hidden text-center text-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h2 className="text-4xl md:text-6xl font-light mb-10 leading-[1.2]">Transform Your <br /> Compliance Posture.</h2>
