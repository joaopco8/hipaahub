...
const CircularProgress: React.FC<{ percentage: number; label: string; valueDisplay?: string }> = ({ percentage, label, valueDisplay }) => {
  ...
  // Using radius 60 in a 128 viewBox to fill the space almost entirely
  const radius = 60;
  const strokeWidth = 8;
    ...
    <div className="flex flex-col items-center">
      <div className="relative w-40 h-40 flex items-center justify-center mb-8">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <span className="text-4xl font-light text-slate-800">{valueDisplay || `${percentage}%`}</span>
        </div>
      </div>
      <p className="text-center text-[13px] text-gray-500 max-w-[180px] leading-relaxed font-light">{label}</p>
    </div>
  );
};
...
const SolidCircleStat: React.FC<{ value: string; label: string }> = ({ value, label }) => {
  return (
    <div className="flex flex-col items-center">
      {/* Container matches CircularProgress (w-40 h-40) */}
      <div className="w-40 h-40 flex items-center justify-center mb-8">
        {/* The actual circle inside is sized to match the visual weight of the SVG progress circles */}
        <div className="w-[124px] h-[124px] rounded-full bg-cisco-green flex items-center justify-center text-white shadow-sm overflow-hidden group">
...
const SolutionSection: React.FC = () => {
  return (
    <section id="solution" className="py-24 bg-white border-b">
      <div className="max-w-7xl mx-auto px-4 md:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start mb-32">
          ...
          <div className="lg:col-span-4">
            <h2 className="text-[42px] font-light text-cisco-navy leading-[1.1] tracking-tight">
          ...
          <div className="lg:col-span-8 flex items-start gap-10">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-gray-500 text-[15px] font-light leading-relaxed max-w-2xl">
