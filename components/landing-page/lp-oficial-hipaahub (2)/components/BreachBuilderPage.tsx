          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-8 mb-12">
               <div className="p-6 bg-gray-50 border border-gray-100">
                  ...
                  <p className="text-xs text-gray-500 font-light">Expert response support for confirmed medical data breaches.</p>
               </div>
               <div className="p-6 bg-gray-50 border border-gray-100">
                  <h4 className="text-sm font-bold text-cisco-navy mb-2">Template Vault</h4>
                  <p className="text-xs text-gray-500 font-light">Legally-reviewed letters for patient, HHS, and media notifications.</p>
               </div>
            </div>
