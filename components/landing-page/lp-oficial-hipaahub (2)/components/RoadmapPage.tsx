      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          <div className="text-center mb-24">
            <h1 className="text-4xl md:text-[54px] font-light text-cisco-navy mb-6">Strategic Implementation.</h1>
             ...
             {[
               ...
               <div key={i} className="bg-white p-8 border border-gray-100 flex flex-col justify-between h-full group hover:border-cisco-blue transition-all">
                 <div>
                    ...
                    <h4 className="text-2xl font-light text-cisco-navy mb-4">{item.phase}</h4>
          ...
          <div className="max-w-4xl mx-auto bg-cisco-navy p-12 text-white relative overflow-hidden">
             <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
                <div className="max-w-lg">
                   <h3 className="text-3xl font-light mb-6">Track Implementation Progress in Real-Time.</h3>
