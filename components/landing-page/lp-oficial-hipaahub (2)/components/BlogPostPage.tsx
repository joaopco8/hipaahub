    ...
    <div className="bg-white">
      ...
      <article className="pb-24">
        ...
        <div className="bg-cisco-navy text-white py-20">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <h1 className="text-4xl md:text-6xl font-light leading-tight mb-10">
              {post.title}
            </h1>
        ...
        <div className="max-w-5xl mx-auto px-4 -mt-12">
          <img 
            src={post.image} 
            alt={post.title} 
            className="w-full h-[500px] object-cover shadow-2xl rounded-none border-b-8 border-cisco-blue"
          />
        </div>

        {/* Content Body */}
        <div className="max-w-3xl mx-auto px-4 mt-20">
          <div className="prose prose-lg prose-slate max-w-none text-gray-600 font-normal leading-relaxed">
            <p className="text-2xl font-light text-slate-800 mb-10 leading-relaxed italic">
            ...
            <h2 className="text-3xl font-light text-cisco-navy mt-12 mb-6">The Shifting Regulatory Horizon</h2>
            <p className="mb-8">
            ...
            <div className="bg-gray-50 border-l-4 border-cisco-blue p-10 my-12">
            ...
            <h2 className="text-3xl font-light text-cisco-navy mt-12 mb-6">Actionable Steps for Clinics</h2>
            <p className="mb-8">
          ...
          <div className="bg-cisco-blue p-12 text-white flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="max-w-md">
              <h3 className="text-3xl font-light mb-4">Ready to secure your clinic?</h3>
      ...
      <section className="bg-gray-50 py-24">
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          <h2 className="text-3xl font-light text-cisco-navy mb-12">Recommended reading</h2>
