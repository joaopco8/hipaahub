    ...
    <section className="py-24 bg-gray-50 border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 md:px-12">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-4xl lg:text-[48px] font-light text-cisco-navy leading-[1.2] mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <button className="bg-cisco-blue text-white px-10 py-5 text-xs font-bold hover:bg-cisco-navy transition-all">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 w-full h-full border border-cisco-blue/10 -z-10 translate-x-4 translate-y-4"></div>
          </div>
        </div>
      </div>
    </section>
