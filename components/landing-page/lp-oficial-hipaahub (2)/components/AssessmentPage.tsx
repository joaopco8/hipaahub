    ...
    return (
      <div className="bg-white min-h-screen flex flex-col items-center justify-center px-4 py-24">
        <div className="max-w-xl text-center">
          ...
          <h2 className="text-4xl font-light text-cisco-navy mb-6">Assessment Request Received.</h2>
          ...
          <button 
            onClick={onBack}
            className="bg-cisco-navy text-white px-10 py-4 text-sm font-normal hover:bg-cisco-blue transition-all"
          >
            Return to Dashboard
          </button>
        </div>
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-white pt-24 pb-16 md:pt-32 md:pb-24 border-b">
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          <div className="max-w-4xl">
            ...
            <p className="text-gray-500 text-lg md:text-2xl font-light leading-relaxed max-w-2xl">
      ...
      <section className="py-24 bg-gray-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 md:px-12 grid lg:grid-cols-5 gap-20">
          ...
          <div className="lg:col-span-2 space-y-16">
            <div>
              <h3 className="text-2xl font-light text-cisco-navy mb-8">What to expect.</h3>
            ...
            <div className="bg-cisco-navy p-10 text-white shadow-2xl relative">
              ...
              <h4 className="text-xl font-light mb-6 tracking-tight">Confidentiality Guarantee</h4>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white p-10 md:p-16 shadow-xl border border-gray-100 relative">
              ...
              <h3 className="text-2xl font-light text-cisco-navy mb-12 tracking-tight">Organization Profile</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-12">
                ...
                <div className="pt-10 border-t border-gray-50 flex flex-col md:flex-row items-center justify-between gap-8">
                  <p className="text-[10px] text-gray-400 font-normal max-w-[200px] leading-relaxed">
                    By submitting, you agree to our institutional privacy framework.
                  </p>
                  <button 
                    type="submit"
                    className="w-full md:w-auto bg-cisco-blue text-white px-12 py-5 text-sm font-normal transition-all flex items-center justify-center gap-3"
                  >
      ...
      <section className="py-24 bg-white border-t">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-5xl font-light text-cisco-navy mb-10">Institutional Response <br /> Methodology.</h2>
          <p className="text-gray-500 text-lg md:text-xl font-light mb-12 leading-relaxed">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {["Technical", "Physical", "Administrative", "Organizational"].map(cat => (
              <div key={cat} className="p-6 bg-gray-50 border border-gray-100">
                ...
                <p className="text-xs text-cisco-navy mt-2 font-normal">Safeguard Audit</p>
              </div>
            ))}
          </div>
        </div>
