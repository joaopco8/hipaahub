...
const AssessmentStep: React.FC<{
  ...
  <div className="flex gap-6 relative group">
    <div className="flex-shrink-0 w-12 h-12 bg-cisco-navy text-white flex items-center justify-center font-light text-xl group-hover:bg-cisco-blue transition-colors">
      {number}
    </div>
    <div className="pt-2">
      <h4 className="text-xl font-light text-cisco-navy mb-2">{title}</h4>
