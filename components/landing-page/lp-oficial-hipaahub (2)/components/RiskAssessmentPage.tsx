            ...
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-12 shadow-2xl">
                 <div className="flex items-center justify-between mb-12">
                    ...
                    <span className="text-4xl font-light text-amber-500">68/100</span>
                 </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-12 grid md:grid-cols-3 gap-16">
          <div className="space-y-6">
            ...
            <h3 className="text-2xl font-light text-cisco-navy">Granular Analysis</h3>
          ...
          <div className="space-y-6">
            ...
            <h3 className="text-2xl font-light text-cisco-navy">Vulnerability Prioritization</h3>
            <p className="text-gray-500 font-light leading-relaxed">
          ...
          <div className="space-y-6">
            ...
            <h3 className="text-2xl font-light text-cisco-navy">Continuous Benchmarking</h3>
            <p className="text-gray-500 font-light leading-relaxed">
