...
const RegulatoryTrackerItem: React.FC<{
  ...
  <div className="flex gap-8 group">
    ...
    <div className="pb-16 pt-[-4px]">
      ...
      <h4 className="text-xl font-light text-cisco-navy mb-4 group-hover:text-cisco-blue transition-colors cursor-pointer">{title}</h4>
      <p className="text-gray-500 text-sm font-light leading-relaxed max-w-2xl">{desc}</p>
    </div>
  </div>
);
          ...
          <div className="grid lg:grid-cols-3 gap-24 items-start">
            ...
            <div className="space-y-12">
              <div className="bg-white p-10 shadow-xl border border-gray-100">
                ...
                <h4 className="text-xl font-light text-cisco-navy mb-4">Legal Deep Dives</h4>
              ...
              <div className="bg-cisco-navy p-10 text-white relative overflow-hidden">
                <div className="relative z-10">
                   ...
                   <h3 className="text-2xl font-light mb-8">Ready for the 2026 <br /> Privacy Rule Update?</h3>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-12 grid md:grid-cols-3 gap-16">
          <div className="space-y-6">
            ...
            <h3 className="text-2xl font-light text-cisco-navy">Institutional Mapping</h3>
          ...
          <div className="space-y-6">
            ...
            <h3 className="text-2xl font-light text-cisco-navy">State-by-State Analysis</h3>
            <p className="text-gray-500 font-light leading-relaxed">
          ...
          <div className="space-y-6">
            ...
            <h3 className="text-2xl font-light text-cisco-navy">Audit Defensibility</h3>
            <p className="text-gray-500 font-light leading-relaxed">
