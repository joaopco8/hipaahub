    ...
    <section className="bg-cisco-navy py-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-12 grid lg:grid-cols-2 gap-16 items-center">
        <div className="text-white">
          ...
          <p className="text-gray-300 text-lg font-light leading-relaxed mb-10 max-w-lg">
          ...
          <div className="flex items-center space-x-6">
            <button className="bg-white text-cisco-navy px-8 py-3 font-light hover:bg-gray-100 transition-colors">
              Start for free
            </button>
            <a href="#" className="flex items-center text-white font-light group">
