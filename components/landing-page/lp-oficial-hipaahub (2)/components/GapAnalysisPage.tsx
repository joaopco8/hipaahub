        ...
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-6xl font-light text-cisco-navy mb-10 leading-tight">
              ...
              <div className="space-y-4 mb-12">
                 {[
                   ...
                   <div key={i} className="flex items-center text-sm font-normal text-slate-700">
