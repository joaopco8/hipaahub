    ...
    <section id="features" className="relative bg-cisco-navy py-20 md:py-32 overflow-hidden border-t border-white/5">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-12">
        <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
          <h2 className="text-4xl lg:text-[56px] font-light mb-8 leading-[1.25] text-white">
        ...
        {/* Large Platform Overview Photo Placeholder */}
        <div className="mb-20 bg-white/5 border border-white/10 aspect-[21/9] flex flex-col items-center justify-center group overflow-hidden">
            <div className="w-full h-full flex flex-col items-center justify-center relative">
               <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#00bceb_1px,transparent_1px)] [background-size:20px_20px]"></div>
               <span className="text-white/30 text-sm font-bold relative z-10">Platform Overview Screenshot Placeholder</span>
               <div className="mt-4 flex space-x-2 relative z-10">
                  <div className="w-2 h-2 rounded-full bg-cisco-blue animate-pulse"></div>
                  <div className="w-2 h-2 rounded-full bg-cisco-blue animate-pulse [animation-delay:200ms]"></div>
                  <div className="w-2 h-2 rounded-full bg-cisco-blue animate-pulse [animation-delay:400ms]"></div>
               </div>
            </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 md:gap-24">
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 p-10">
            <div className="flex items-center gap-4 mb-10 border-b border-white/10 pb-6">
              ...
              <h4 className="text-base font-semibold text-white">9 Customizable HIPAA Policies</h4>
            </div>
            <p className="text-gray-400 text-base mb-8 font-light">Pre-built policy templates customized to your organization:</p>
            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-4">
              {policies.map((p, i) => (
                <div key={i} className="flex items-center text-gray-300 font-normal group">
            ...
            {features.map((f, i) => (
              <div key={i} className="bg-white/5 backdrop-blur-md border border-white/10 p-8 flex gap-6 group hover:bg-white/10 transition-all">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm font-light leading-relaxed">{f.text}</p>
                </div>
              </div>
            ))}
          </div>
