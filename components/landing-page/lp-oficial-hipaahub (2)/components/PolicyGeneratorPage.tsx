        ...
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          <div className="flex flex-col md:flex-row gap-16 items-center mb-24">
            <div className="flex-1">
              ...
              <h1 className="text-4xl md:text-5xl font-light text-cisco-navy leading-tight mb-8">
                 ...
                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {policies.map((p, i) => (
                      <div key={i} className="p-4 border border-gray-50 bg-gray-50/30 flex items-center justify-between group hover:border-cisco-blue transition-all cursor-pointer">
                        <span className="text-sm font-light text-slate-800">{p}</span>
          ...
          <div className="grid md:grid-cols-3 gap-12">
             <div className="p-8 bg-white shadow-sm border border-gray-100">
                ...
                <p className="text-sm text-gray-500 font-light">Engine-driven templates that adapt to your specific clinical workflows.</p>
             </div>
             <div className="p-8 bg-white shadow-sm border border-gray-100">
                <History className="text-cisco-blue mb-6" size={32} />
                <h4 className="text-lg font-bold text-cisco-navy mb-4">Version Control</h4>
                <p className="text-sm text-gray-500 font-light">Complete audit trail of all policy revisions, approvals, and distribution.</p>
             </div>
             <div className="p-8 bg-white shadow-sm border border-gray-100">
                ...
                <p className="text-sm text-gray-500 font-light">Automated digital acknowledgment tracking for institutional compliance.</p>
             </div>
          </div>
        </div>
      </section>
