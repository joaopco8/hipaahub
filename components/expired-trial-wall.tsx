...
const PLANS: Plan[] = [
  {
    ...
    priceId: (process.env.NEXT_PUBLIC_STRIPE_SOLO_PRICE_ID ?? 'price_1TEHcrFjJxHsNvNGmvH3pQur').replace(/\s+/g, ''),
    features: [
  ...
  },
  {
    ...
    priceId: (process.env.NEXT_PUBLIC_STRIPE_PRACTICE_PRICE_ID ?? 'price_1TEHd6FjJxHsNvNGahdVbS6N').replace(/\s+/g, ''),
    features: [
      'Everything in Solo',
  ...
  },
  {
    ...
    priceId: (process.env.NEXT_PUBLIC_STRIPE_CLINIC_PRICE_ID ?? 'price_1TEHdcFjJxHsNvNGzViIgMp8').replace(/\s+/g, ''),
    features: [
