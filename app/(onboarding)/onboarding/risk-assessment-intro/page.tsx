      ...
      <div className="space-y-6 max-w-3xl mx-auto w-full">
        <div className="text-center space-y-4">
          <div className="flex justify-center">
            <div className="rounded-full bg-[#1ad07a]/10 p-4">
              <Shield className="h-12 w-12 text-[#1ad07a]" />
            </div>
          </div>
        ...
        <Card className="border-2 border-[#1ad07a]/20 card-premium-enter stagger-item">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Info className="h-5 w-5 text-[#1ad07a]" />
          ...
          <CardContent className="space-y-6">
            ...
            <div className="pt-4 border-t border-zinc-200">
              <div className="bg-zinc-50 rounded-lg p-4 space-y-2">
                <p className="text-sm font-extralight text-zinc-900">
                  Remember:
                </p>
        ...
        <div className="flex justify-center pt-4">
          <Button
            onClick={handleStart}
            disabled={isStarting}
            className="bg-[#1ad07a] text-[#0c0b1d] hover:bg-[#1ad07a]/90 px-8 py-6 text-lg font-extralight"
            size="lg"
          >
