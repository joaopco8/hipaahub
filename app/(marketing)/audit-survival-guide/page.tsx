  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-1">
        ...
        {/* DOWNLOAD SECTION */}
        <section id="download-section" className="w-full bg-gradient-to-b from-[#0c0b1d] via-[#1a1a2e] to-[#0c0b1d] py-20 md:py-28 font-extralight">
          <div className="max-w-7xl mx-auto px-6">
                  ...
                  <div className="space-y-8 text-center">
                    <div className="space-y-4">
                      ...
                      <p className="text-lg text-zinc-600 font-extralight">
                        Download your free HIPAA OCR Audit Survival Guide now
                      </p>
                    </div>
                    ...
                    >
                      <Button
                        ...
                        size="lg"
                        className="w-full sm:w-auto bg-[#1ad07a] text-[#0c0b1d] hover:bg-[#1ad07a]/90 h-14 px-8 text-lg font-medium shadow-lg hover:shadow-xl transition-all"
                      >
                    ...
                    <motion.div
                      className="pt-4 space-y-2 text-sm text-zinc-600 font-extralight"
                      initial={{ opacity: 0 }}
                    ...
                    >
                      ...
                      <div className="flex items-center justify-center gap-2">
                        <CheckCircle2 className="w-4 h-4 text-[#1ad07a]" />
                        <span>25+ pages of actionable guidance</span>
                      </div>
                    </motion.div>
                  </div>
                </motion.div>
